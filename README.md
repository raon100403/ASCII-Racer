...
- `src/chase_camera.rs`: shared terminal/browser follow camera with bounded speed framing and forward look-ahead.
...
- `src/main.rs`: input, HUD, frame timing, and terminal lifetime.
